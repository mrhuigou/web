...
<style type="text/css">
    * { margin: 0; padding: 0;}
    body { font-family: "Microsoft Yahei"; background: #9d26d8}
...
<div class="pt50"></div>
<div class="clearfix">
    <img src="/assets/images/choujiang/singles-day.jpg" class="w">
    <div class="rotary bc">
...
<div class="br5 opc-f p10 m10">
    ...
    <ul class="ul ul-decimal ml25 f14">
        <li>活动时间：11月10日~11月13日</li>
        <li>每个用户ID只能抽1次</li>
        <li>购现金红包11月13日23:59到期，逾期作废</li>
        <li>每笔订单限使用1张</li>
        <li>如有疑问请联系客服 <?= Yii::$app->common->getSiteMobile() ?></li>
    </ul>
</div>
