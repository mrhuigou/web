...
<div class="issuance mt10">
    <div class="pt15 clearfix ">
        <a href="<?=\yii\helpers\Url::to(['/club-feed/user','user'=>$model->customer->customer_id],true)?>" style="width: 58px;" class="clearfix db">
            <img src="<?=Image::resize($model->customer->photo,45,45)?>" alt="ava" width="45" height="45" class="ava sava mr10  pop-show">
        </a>
        <div style="margin-left:58px;margin-top:-46px; ">
                <p > <a href="<?=\yii\helpers\Url::to(['/club-feed/user','user'=>$model->customer->customer_id],true)?>"><?=$model->customer->nickname?></a></p>
