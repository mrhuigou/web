...
<div class=" pt10 pb50">
	...
	<?= h5\widgets\Block\Delivery::widget(['type'=>0]) ?>
	<p class="tit--">商品明细</p>
	<div class=" w">
...
<?php $this->beginBlock('JS_END') ?>
    ...
    $.post('/express/save-order',{address_id:address_id,delivery_date:delivery_date,delivery_time:delivery_time,remark:remark},function(res){
    $.hideLoading();
    if(res.status){
    $.toast('提交成功',function(){
