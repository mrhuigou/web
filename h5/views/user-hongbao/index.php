...
<section class="veiwport  pb50">
        <div class="flex-col tc lh37 aui-border whitebg f14  ">
            <a class="flex-item-6 redbg white" href="<?=\yii\helpers\Url::to(['/user-hongbao/index'])?>">
                我分享的
            </a>
            <a class="flex-item-6 aui-border-l aui-border-r" href="<?=\yii\helpers\Url::to(['/user-hongbao/index','status'=>1])?>">
                帮他人拆的
            </a>
        </div>
