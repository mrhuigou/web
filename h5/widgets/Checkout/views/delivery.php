...
<div id="delivery_form_<?= $data['store_id'] ?>" data-source="<?= $data['store_id'] ?>" class="weui-popup-container">
    ...
    <div class="weui-popup-modal">
        ...
        <div class="delivery-form">
            <input type="hidden" name="CheckoutForm[delivery][<?= $data['store_id'] ?>][date]" class="delivery_date"
                   value="<?= $data['method_date'] ?>">
            <input type="hidden" name="CheckoutForm[delivery][<?= $data['store_id'] ?>][time]" class="delivery_time"
