...
<div class="fx-bottom fx-convert-tar">
    <div class="nav-main clearfix">
        ...
        <a href="<?=\yii\helpers\Url::to(['/category/index'])?>" class="<?=$cur=="category"?"green fb":""?>"><i class="iconfont">&#xe640;</i>分类</a>
        <a href="<?=\yii\helpers\Url::to(['/share/index'])?>"><i class="" style="margin-top:-19px;"><img src="/assets/images/fudai.png" width="30" class="shakesmall"></i><span class="f12 db org">新人福利</span></a>
