...
<!--        <a href="--><?//=\yii\helpers\Url::to(['/choujiang/index'])?><!--"><i class="" style="margin-top:-19px;"><img src="/assets/images/fudai.png" width="30" class="shakesmall"></i><span class="f12 db org">抽奖</span></a>-->
        <a href="<?=\yii\helpers\Url::to(['page/3538.html'])?>" class="<?=$cur=="page"?"green fb":""?>"><i class="" style="margin-top:-19px;"><img src="/assets/images/fudai.png" width="30" class="shakesmall"></i><span class="f12 db org">爆品</span></a>
