			...
			'columns' => [
				...
				['label' => '头像',
					...
					'value' => function ($model) {
						return \common\component\image\Image::resize($model->affiliate->customer->photo,50,50);
					}
				],
				'affiliate.telephone',
				'code',
...
$.post("<?=\yii\helpers\Url::to(['/affiliate-apply-draw/draw'],true)?>",{id:draw_id},function(res){
if(res.status){
