 ...
 */
class AffiliateTransactionSearch extends AffiliateTransactionFlow
{
    public $begin_date;
    public $end_date;
    public $order_no;
    ...
    public function search($params)
    {
        if(!Yii::$app->user->isGuest){
            $query = AffiliateTransactionFlow::find()->where(['affiliate_id'=>Yii::$app->user->getId()]);
        }else{
            $query = AffiliateTransactionFlow::find()->where(['affiliate_id'=>0]);
        }
