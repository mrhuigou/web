...
<nav class="fx-bottom fx-convert-tar">
    <div class="nav-main clearfix">
        ...
        <a href="<?=\yii\helpers\Url::to(['/cart/index'])?>" class="pr ">
            ...
            <?php if(Yii::$app->fxcart->getCount()){ ?><em class="info-point cart_qty"><?=Yii::$app->fxcart->getCount()?></em><?php }else{ ?>
                <em class="info-point cart_qty" style="display:none"><?=Yii::$app->fxcart->getCount()?></em>
            <?php } ?>
        </a>
