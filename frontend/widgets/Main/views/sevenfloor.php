...
<?php if(isset($data['img_promotion_1_data']) && !empty($data['img_promotion_1_data'])){?>
    ...
    <?php }?>
<?php }?>
<div class="floor-container floor3">
    <div class="clearfix pt10 pb10" style="border-bottom:2px solid #eaba00;">
        <div class="bg"></div>
        <div class="fl lh250">
            <i class="iconfont yellow f30 mr5" style="font-size:35px!important;">&#xe639;</i><span class="f18 fb">休闲食品</span>
        </div>
        ...
        <div class="w240 fl">
            <?php if(isset($data['img_left_top1_data']) && !empty($data['img_left_top1_data'])){?>
                <?php foreach($data['img_left_top1_data'] as $key => $banner){?>
                    <?php if($key < 1){?>
                        <a target="_blank" class="scaleimg" href="<?php echo $banner->link_url;?>"><img  src="/assets/images/placeholder.png" data-url="<?php echo \common\component\image\Image::resize($banner->source_url,$banner->width,$banner->height,9);?>" alt="<?php echo $banner->title;?>" width="240" height="240" class="db lazy" /></a>
                    <?php }?>
                <?php }?>
            <?php }?>
                    ...
                    <div class="bd">
                        <ul>
                            <?php foreach($data['img_middle_left_topn_data'] as $banner){?>
                                <li><a href="<?php echo $banner->link_url;?>" class="" target="_blank"><img class="db lazy" src="/assets/images/placeholder.png" data-url="<?php echo \common\component\image\Image::resize($banner->source_url,$banner->width,$banner->height,9);?>" alt="<?php echo $banner->title;?>" width="384" height="384" /></a></li>
                            <?php }?>
                        </ul>
                    </div>
                <?php }?>
    ...
    <div class="clearfix">
        <?php if(isset($data['pack_bottom3_data']) && !empty($data['pack_bottom3_data'])){?>
            <?php foreach($data['pack_bottom3_data'] as $key => $banner){?>
                <?php if($key < 5){?>
                    <a target="_blank" class="w240 fl scaleimg" href="<?php echo $banner->link_url;?>"><img  src="/assets/images/placeholder.png" data-url="<?php echo \common\component\image\Image::resize($banner->source_url,$banner->width,$banner->height,9);?>" alt="<?php echo $banner->title;?>" width="240" height="240" class="db lazy" /></a>
                <?php }?>
            <?php }?>
        <?php }?>
    </div>
            ...
            <div class="bd brands mt5" style="border: 0;">
                <ul class="clearfix">
                    <?php foreach($data['brand_bottomn_data'] as $key => $banner){?>
                        <li>
                        <a target="_blank" class="scaleimg" href="<?php echo $banner->link_url;?>"><img  src="/assets/images/placeholder.png" data-url="<?php echo \common\component\image\Image::resize($banner->source_url,$banner->width,$banner->height,9);?>" alt="<?php echo $banner->title;?>" width="120" height="65" class="db lazy" /></a>
                           </li>
                    <?php }?>
                </ul>
            </div>
