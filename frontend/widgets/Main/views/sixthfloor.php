...
<?php }?>
<!--楼层5-->
<div class="floor-container floor5">
    <div class="clearfix pt10 pb10" style="border-bottom:2px solid #ed5400;">
        <div class="bg"></div>
        <div class="fl lh250">
            <i class="iconfont org f30 mr5">&#xe619;</i><span class="f18 fb">日用百货</span>
        </div>
