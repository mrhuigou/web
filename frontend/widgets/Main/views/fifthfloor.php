<?php if(isset($data['img_promotion_1_data']) && !empty($data['img_promotion_1_data'])){?>
    ...
    <?php }?>
<?php }?>
<div class="floor-container floor4">
    <div class="clearfix pt10 pb10" style="border-bottom:2px solid #0098dc;">
        <div class="bg"></div>
        <div class="fl lh250">
            <i class="iconfont blue f30 mr5">&#xe615;</i><span class="f18 fb">个护洗化</span>
        </div>
