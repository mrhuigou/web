<?php if(isset($data['img_promotion_1_data']) && !empty($data['img_promotion_1_data'])){?>
    ...
    <?php }?>
<?php }?>
<div class="floor-container floor2">
    <div class="clearfix pt10 pb10" style="border-bottom:2px solid #c80082;">
        <div class="bg"></div>
        <div class="fl lh250">
            <i class="iconfont purple f30 mr5" style="font-size: 35px!important;">&#xe617;</i><span class="f18 fb">酒水饮料</span>
        </div>
        ...
        <div class="w576 fl clearfix">
            <div class="Items smp">
                <div class="item-wrap item-3">
                    <?php if(isset($data['img_rigth_top6_data']) && !empty($data['img_rigth_top6_data'])){?>
                        <?php foreach($data['img_rigth_top6_data'] as $key => $banner){?>
    ...
    <div class="clearfix">
        <?php if(isset($data['pack_bottomn_data']) && !empty($data['pack_bottomn_data'])){?>
            <?php foreach($data['pack_bottomn_data'] as $key => $banner){?>
                <?php if($key < 5){?>
                    <a target="_blank" class="w240 fl scaleimg" href="<?php echo $banner->link_url;?>"><img  src="/assets/images/placeholder.png" data-url="<?php echo \common\component\image\Image::resize($banner->source_url,$banner->width,$banner->height,9);?>" alt="<?php echo $banner->title;?>" width="240" height="170" class="db lazy" /></a>
                <?php }?>
            <?php }?>
        <?php }?>
