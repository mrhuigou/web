    ...
    <form class="comment_form">
        <div class="fl w mt5">
            <div style="margin-left:55px;margin-right:184px;">
                <input name="type_name_id" type="hidden" value="<?=$type_name_id?>">
...
$("body").on('click','.comment_submit',function(){
    $.post('<?=\yii\helpers\Url::to(['/club/club-comment/submit'])?>',$(this).parents(".comment_form").serialize(),function(data){
        if(data){
            alert(data);
        }else{
