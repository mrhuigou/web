...
<div class="graybg clearfix mb10 pr hovercr">
    ...
    <div class="pa-b bd_dashT p5" style="margin-left: 200px;">
        ...
        <div class="bd tc p10 w150  pa opc-0 white" id="http//m.365jiarun.com/club-activity/detail?id=<?=$model->id?>" style="right: 0px;bottom: 30px;min-height:139px;display: none ">
