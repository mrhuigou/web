 ...
 *
 */
namespace common\component\Payment\Upop;
class quickpay_service
{
    ...
    {
        $html ="<form  id='upop_submit' name='pay_form' action='{$this->api_url}'method='post'>";
        foreach ($this->args as $key => $value) 
		{
            $html .= " <input type=\"hidden\" name=\"{$key}\" id=\"{$key}\" value=\"{$value}\" />\n";
        }
        $html .= "</form>";
        $html = $html."<script>document.forms['upop_submit'].submit();</script>";
		return $html;
    }
