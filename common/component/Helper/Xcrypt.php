...
class Xcrypt{
    ...
    private $mcrypt;
    private $key = "C7CAED85F4C0B90876BF891FA5220C00"; //二维码加密key   ／／input加密key：qwertyu8（短标）
    private $mode;
    private $iv;
    private $blocksize;
     ...
     */
    public function __construct($key="C7CAED85F4C0B90876BF891FA5220C00", $mode = 'cbc', $iv = "off"){
        switch (strlen($key)){
            case 8:
